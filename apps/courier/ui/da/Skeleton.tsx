...
export function SkeletonLine({ app: appProp, h=12, w="100%", r=12, style }: { app?: DAApp; h?: number; w?: ViewStyle["width"]; r?: number; style?: ViewStyle; }){
  const appId = appProp ?? APP;
  const t = getDATheme(appId);
