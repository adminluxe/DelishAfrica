...
export default function SignatureHomeClient() {
 ...
 const apiUrl = "https://api.delishafrica.me/api/v1";

 useEffect(() => {
 // UX: simulate ping variance 
 ...
 <View style={{ height: 8 }} />
 <Text style={[styles.status, { color: (c as any).success }]}>Status: ok • {Math.round(apiMs)}ms</Text>
 </Card>
 ...
 <Button label="Commander " variant="primary" onPress={() => {}} />
 ...
 <TimelineItem label="Commande" text="Créer la commande Thieyp." state="active" />
