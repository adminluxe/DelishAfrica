...
import { demoMissions } from "../demo-missions";
...
export default function MissionDetail() {
  ...
  const handleConfirm = () => {
    ...
    Alert.alert(
      "Mission terminée",
      "La mission a été marquée comme livrée (démo)."
    );
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.badge}>Mission démo</Text>
      ...
      <View style={styles.stepCard}>
        ...
        <Text style={styles.stepText}>
          ...
          {step === "photo" && "Étape 3/3 – Photo de confirmation (démo)."}
          {step === "terminee" && "Mission terminée ✔️ (démo)."}
        </Text>
      </View>
