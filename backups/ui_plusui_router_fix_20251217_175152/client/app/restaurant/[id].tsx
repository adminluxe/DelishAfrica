...
export default function RestaurantScreen() {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#020617' }} contentContainerStyle={{ padding: 20 }}>
      ...
      >
        <Text style={{ fontWeight: '700', color: '#020617' }}>Lancer une commande (démo)</Text>
      </Pressable>
    </ScrollView>
  );
}
