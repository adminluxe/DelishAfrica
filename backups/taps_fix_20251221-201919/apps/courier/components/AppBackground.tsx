...
export default function AppBackground({
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors[0] }]}>
      ...
      <View style={[styles.layer, { backgroundColor: colors[1], opacity: 0.92 }]} />
      <View style={[styles.layer, { backgroundColor: colors[2], opacity: 0.86 }]} />
      ...
      {/* voile global */}
      <View style={[styles.vignette, { opacity: isDark ? 0.55 : 0.16 }]} />
