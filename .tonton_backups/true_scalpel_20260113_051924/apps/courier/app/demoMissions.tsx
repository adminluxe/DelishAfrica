...
const DemoMissionsScreen: React.FC = () => {
 ...
 >
 <Text style={styles.title}>Missions (courier)</Text>

 <Text style={styles.subtitle}>
 Écran helper. Dans la , on utilise surtout l'écran d'accueil pour la
 vraie mission.
 </Text>

 <View style={styles.card}>
 <Text style={styles.cardTitle}>Livraison #-001</Text>
 ...
 <View style={styles.card}>
 <Text style={styles.cardTitle}>Livraison #-002</Text>
