...
export default function OrdersDebugScreen() {
 ...
 <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ padding: 12, borderWidth: 1, borderRadius: 12, marginBottom: 12 }}>
 ...
 <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ flexDirection: "row", gap: 10 as any, marginTop: 10 }}>
 <Pressable
 onPress={() => setAuto((v) => !v)}
 style={{
 paddingVertical: 10,
 ...
 <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ padding: 12, borderWidth: 1, borderRadius: 12 }}>
