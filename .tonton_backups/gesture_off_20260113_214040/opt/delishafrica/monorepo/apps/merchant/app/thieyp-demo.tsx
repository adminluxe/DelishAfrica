...
export default function OrdersDebugScreen() {
 ...
 const url = `${API_BASE}/api/v1/orders//list`;
 ...
 return (
 <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" style={{ padding: 16 }}>
 ...
 <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" contentContainerStyle={{ flexGrow: 1 }} style={{ padding: 12, borderWidth: 1, borderRadius: 12, marginBottom: 12 }}>
 ...
 <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" contentContainerStyle={{ flexGrow: 1 }} style={{ flexDirection: "row", gap: 10 as any, marginTop: 10 }}>
 <Pressable
 onPress={() => setAuto((v) => !v)}
 style={{
 paddingVertical: 10,
 ...
 <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" contentContainerStyle={{ flexGrow: 1 }} style={{ padding: 12, borderWidth: 1, borderRadius: 12 }}>
