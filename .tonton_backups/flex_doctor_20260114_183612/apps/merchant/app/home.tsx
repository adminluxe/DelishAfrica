...
export default function OrdersScreen() {
 ...
 return (
 <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" style={{ flex: 1, backgroundColor: "#0B0F14" }} contentContainerStyle={{ padding: 18, paddingBottom: 40 }}>
