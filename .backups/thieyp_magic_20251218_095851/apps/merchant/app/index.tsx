...
import { Screen, H1, P, Card, Badge, Button, theme } from "../ui/ui";
import { useApiHealth } from "../ui/useApiHealth";
  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={{ paddingBottom: 28 }}>
        <H1>DelishAfrica • Merchant</H1>
        <P>Cuisine. Commandes. Production.</P>
        ...
        <Card style={{ marginTop: 16 }}>
          ...
          <Button title="Action principale (démo)" variant="ghost" onPress={() => router.push("/orders-demo")} />
        </Card>
