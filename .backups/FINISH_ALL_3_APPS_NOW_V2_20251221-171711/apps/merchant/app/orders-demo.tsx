        ...
        >
          ...
          <View style={{ gap: 8 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <Text style={{ color: "rgba(255,255,255,0.88)", fontWeight: "900" }}>Tonton (démo)</Text>
            </View>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <Text style={{ color: "rgba(255,255,255,0.88)", fontWeight: "900" }}>DA-DEMO-THIEYP-001</Text>
            </View>
          </View>
          ...
          <View style={{ marginTop: 6, padding: 10, borderRadius: 14, backgroundColor: "rgba(0,0,0,0.18)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" }}>
            <Text style={{ color: "rgba(255,255,255,0.70)", fontSize: 12, fontWeight: "800", lineHeight: 16 }}>
              Démo “safe” : écran Merchant lisible (entrant → accepté → prêt). Aucun impact sur le routing existant.
            </Text>
          </View>
        </View>
