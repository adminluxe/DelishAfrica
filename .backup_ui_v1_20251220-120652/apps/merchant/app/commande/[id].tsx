...
export default function OrderScreen() {
  ...
  const getStatusLabel = () => {
    ...
    return 'Prête pour le coursier (démo)';
  };
  ...
  const getButtonLabel = () => {
    if (status === 'received') return 'Commencer la préparation (démo)';
    if (status === 'preparing') return 'Marquer comme prête (démo)';
