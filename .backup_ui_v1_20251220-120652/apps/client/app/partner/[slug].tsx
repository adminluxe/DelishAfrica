...
const FALLBACK: PartnerDetail[] = [
  {
    ...
    cuisine: "Sénégalais",
    rating: 4.8,
    description: "Démo partenaire — focus Thieyp (fallback si API indisponible).",
    address: "Bruxelles",
  },
  {
    slug: "afrosian",
    ...
    rating: 4.6,
    description: "Démo partenaire (fallback) — carte & infos à enrichir.",
    address: "Bruxelles",
  },
  {
    slug: "toukoul",
...
export default function PartnerScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      {/* Background bubbles */}
      <View style={{ position: "absolute", top: -80, right: -90, width: 260, height: 260, borderRadius: 999, backgroundColor: "#0B2A4A", opacity: 0.35 }} />
      <View style={{ position: "absolute", bottom: -120, left: -110, width: 320, height: 320, borderRadius: 999, backgroundColor: "#111827", opacity: 0.35 }} />
